...
function sumArray(sumArr) { //eslint-disable-line
  ...
  let stringAnswer = sumArr + ' was passed in as an array of numbers, and ' + total + ' is their sum.'
  console.log(stringAnswer)

  return [total,stringAnswer]
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  let total = multiply(multiply(multArr[0],multArr[1])[0],multArr[2])[0];
  console.log(total,'H');

  let stringAnswer = 'The numbers ' + multArr + ' have a product of ' + total + '.';
  console.log(stringAnswer, 'G');
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
 ...
 let answer = multiply(dynamicArray[0],dynamicArray[1])[0]; 
  ...
  let stringAnswer = 'The numbers ' + dynamicArray + ' have a product of ' + answer + '.';
  console.log(stringAnswer, 'G');
  console.log(answer);
